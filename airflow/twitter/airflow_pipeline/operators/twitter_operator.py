...
class TwitterOperator(BaseOperator):
    """
    Lista de campos que podem ser utilizados no template
    """
    ...
    def __init__(self,file_path, end_time, start_time, query, **kwargs):
        ...
        Args:
            ...
            file_path (st): Caminho para salvar o arquivo
        """
    ...
    def create_parent_folder(self):
        """
        Função para criar as pastas onde os dados serão salvos, se a pasta existir não vai ser criada
        """
        (Path(self.file_path).parent).mkdir(parents=True, exist_ok=True)
    
    def execute(self, context):
        """
        Executa as operações de busca, cria as pastas e salva o json
...
if __name__ == "__main__":
    ...
    Busca pelo dados de ontem até hoje
    Salva os dados no formato de json com a tag e a data
    """
