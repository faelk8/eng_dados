...
class TwitterOperator(BaseOperator):
    """
    Lista de campos que podem ser utilizados
    """
    ...
    def create_parent_folder(self):
        """
        Função para criar as pastas onde os dados serão salvos
        """
        (Path(self.file_path).parent).mkdir(parents=True, exist_ok=True)
    
    def execute(self, context):
        """
        Função para executar as operações de buscar, cria as pastas e salva o json
        """
